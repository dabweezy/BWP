      ...
      <div className="container mx-auto px-4 sm:px-8 lg:px-16 xl:px-24">
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-4 sm:p-8 lg:p-12">
            ...
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-16 items-center mb-8 sm:mb-16">
              ...
              <div className="space-y-6 sm:space-y-8">
                <div className="text-center lg:text-left">
                  <div className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold text-slate-900 mb-3 sm:mb-4">85%</div>
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 sm:w-3 sm:h-3 bg-slate-900 rounded-full flex-shrink-0"></div>
                    <span className="text-sm sm:text-base lg:text-lg text-slate-700">High-resolution printing on any surface</span>
                  </div>
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 sm:w-3 sm:h-3 bg-slate-900 rounded-full flex-shrink-0"></div>
                    <span className="text-sm sm:text-base lg:text-lg text-slate-700">Durable, long-lasting results</span>
                  </div>
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 sm:w-3 sm:h-3 bg-slate-900 rounded-full flex-shrink-0"></div>
                    <span className="text-sm sm:text-base lg:text-lg text-slate-700">Professional installation service</span>
                  </div>
                </div>
                ...
                <div className="pt-2 sm:pt-4">
                  <a
                    href="#contact"
                    className="inline-flex items-center px-6 sm:px-8 py-3 sm:py-4 bg-slate-900 text-white rounded-xl font-semibold hover:bg-slate-800 transition-all duration-300 shadow-lg hover:shadow-xl text-sm sm:text-base"
                  >
                    Get Started
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="bg-slate-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-slate-200">
                  <div className="flex items-center space-x-3 sm:space-x-4 mb-3 sm:mb-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-slate-900 text-sm sm:text-base">Office Spaces</h3>
                      <p className="text-xs sm:text-sm text-slate-600">Professional branding & motivational graphics</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-slate-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-slate-200">
                  <div className="flex items-center space-x-3 sm:space-x-4 mb-3 sm:mb-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-slate-900 text-sm sm:text-base">Hospitality Venues</h3>
                      <p className="text-xs sm:text-sm text-slate-600">Restaurants, cafes & themed environments</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-slate-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-slate-200">
                  <div className="flex items-center space-x-3 sm:space-x-4 mb-3 sm:mb-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-slate-900 text-sm sm:text-base">Retail Stores</h3>
                      <p className="text-xs sm:text-sm text-slate-600">Eye-catching displays & brand enhancement</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="border-t border-slate-200 pt-8 sm:pt-16">
              <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                ...
                {/* Right side - Image */}
                <div className="aspect-[4/3] rounded-xl sm:rounded-2xl shadow-lg overflow-hidden">
                  <img 
